...
document.addEventListener("DOMContentLoaded", function() {
    let anchor = document.querySelector('#btn_fonctionnement'); // Sélection du bouton spécifique
    if (anchor) { // Vérifie si le bouton existe
      anchor.addEventListener('click', function(e) {
        ...
        if (targetElement) { // Vérifie si l'élément cible existe
          let offsetPosition = targetElement.offsetTop - 125;
