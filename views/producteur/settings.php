...
<head>
    ...
    <link rel=stylesheet href="styles/producer/settings.css">
...
<body>
    ...
    <div class="right-div">
        ...
        if (isset($_GET["error"]) && $_GET["error"]) {
            require_once("lib/components/components/notification.php");
            ...
            if ($_GET["error"] == "siret_already_used")
                echo (createNotification("error", "Ce numéro de SIRET est déjà utilisé", 5000));
